...
class NavbarOrganization extends StatelessWidget {
      ...
      child: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
            ...
            activeIcon: _buildActiveIcon(context, Icons.record_voice_over),
            label: 'Suara',
          ),
          BottomNavigationBarItem(
            icon: const Icon(Icons.inbox_outlined),
            activeIcon: _buildActiveIcon(context, Icons.inbox),
            label: 'Penerimaan',
          ),
          BottomNavigationBarItem(
